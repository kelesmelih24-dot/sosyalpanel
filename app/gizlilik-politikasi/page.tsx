    ...
    <div className="min-h-screen bg-void">
      ...
      <div className="mx-auto max-w-2xl px-5 py-16 text-mute">
        ...
        <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed">
          <section>
            <h2 className="font-display font-semibold text-ink">1. Toplanan Veriler</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">2. Verilerin Kullanım Amacı</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">3. Verilerin Paylaşımı</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">4. Veri Saklama Süresi</h2>
            <p className="mt-2">[Yasal saklama sürelerini mali müşavirinle netleştirip buraya yaz.]</p>
          </section>
          <section>
            <h2 className="font-display font-semibold text-ink">5. Haklarınız</h2>
            <p className="mt-2">
              6698 sayılı KVKK kapsamındaki haklarınız için{" "}
              <Link href="/kvkk-aydinlatma" className="text-cyan hover:underline">KVKK Aydınlatma Metni</Link>{" "}
              sayfamızı inceleyebilirsiniz.
            </p>
          </section>
          <section>
            <h2 className="font-display font-semibold text-ink">6. İletişim</h2>
