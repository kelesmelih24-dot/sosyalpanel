  ...
  return (
    <div className="min-h-screen bg-void">
      ...
      <div className="mx-auto max-w-2xl px-5 py-16 text-mute">
        <h1 className="font-display text-3xl font-bold text-ink">Kullanım Şartları</h1>
        ...
        <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed">
          <section>
            <h2 className="font-display font-semibold text-ink">1. Taraflar</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">2. Hizmetin Niteliği</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">3. Kullanıcı Sorumlulukları</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">4. Bakiye ve Ödemeler</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">5. Sipariş İptali ve İade</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">6. Sorumluluk Sınırı</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">7. Uyuşmazlıkların Çözümü</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display font-semibold text-ink">8. İletişim</h2>
